...
class AddEarringPage extends StatefulWidget {
  @override
  _AddEarringPageState createState() => _AddEarringPageState();
}

class _AddEarringPageState extends State<AddEarringPage> {
  ...
  void addEarrings() async {
    ...
    if (name.isNotEmpty && price > 0 && imageFile != null) {
      ...
      FirebaseFirestore.instance.collection('Earrings').add({
        'name': name,
        'price': price,
        'weight': weight,
        'carat': carat,
