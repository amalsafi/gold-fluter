...
class AddBraceletsPage extends StatefulWidget {
  @override
  _AddBraceletsPageState createState() => _AddBraceletsPageState();
}

class _AddBraceletsPageState extends State<AddBraceletsPage> {
  ...
  void addBracelets() async {
    ...
    if (name.isNotEmpty && price > 0 && imageFile != null) {
      ...
      FirebaseFirestore.instance.collection('Bracelets').add({
        'name': name,
        'price': price,
        'weight': weight,
        'carat': carat,
