...
// // class DisplayRingsPage extends StatelessWidget {
// //   @override
// //   Widget build(BuildContext context) {
// //     return Scaffold(
// //       appBar: AppBar(
// //         title: Text('Rings Store'),
// //       ),
...
// //   RingItem({required this.imageUrl, required this.name});
...
// //   ProductDetailsPage({required this.imageUrl, required this.name});
